...
• output_contract – sections_required must be an array that contains ALL of the following 18 strings at least once (no extras): "Abstract", "Introduction", "Prior Work Comparison", "Method Statement", "Variables And Units Table", "Model Equations", "Solution Derivation", "Results", "Analysis", "Validation", "Conclusion", "Actionable Recommendation", "Novelty Statement", "References", "Evidence & Citations", "Glossary", "Redundancy Check", "Refinement Hooks". formatting must be exactly { "math_notation": "latex"|"unicode", "explanation_detail": "terse"|"detailed" } with NO other properties. safety_note must be { "flag": boolean, "content": string } with NO other properties. DO NOT include number_format, significant_figures, novelty_badge, interpretability_requirements, or any other properties not listed here.
...
const buildUserPrompt = (options: SchemaGenerationOptions = {}): string => {
  ...
  return [
    ...
    '- output_contract.sections_required must include EXACTLY these 18 required sections (no custom names): "Abstract", "Introduction", "Prior Work Comparison", "Method Statement", "Variables And Units Table", "Model Equations", "Solution Derivation", "Results", "Analysis", "Validation", "Conclusion", "Actionable Recommendation", "Novelty Statement", "References", "Evidence & Citations", "Glossary", "Redundancy Check", "Refinement Hooks".',
